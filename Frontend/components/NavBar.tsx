  ...
  return (
    <header className="relative w-full h-[80px] py-5 px-5 md:px-5 flex items-center justify-between bg-white">
      ...
      <div className={`${bricolageGrotesque.className} flex items-center gap-2`}>
        ...
        <Link href="https://linkedin.com/in/lakshyaveersingh/" aria-label="LinkedIn" className="text-slate-700 hover:text-slate-900">
          <Linkedin className="h-4 w-4" />
        </Link>
        <Link href="https://github.com/veerLakshya/LLMvsLLMChess/" aria-label="GitHub" className="text-slate-700 hover:text-slate-900 ">
